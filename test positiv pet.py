...
def test_add_new_pet_with_valid_data(name='Terry', animal_type='coon',
                                     age=1, pet_photo='images/coon1.jpg'):
...
def test_add_photo_of_pet_valid_id(pet_photo='images/coon2.jpg'):
    ...
    if len(my_pets['pets']) == 0:
        pf.post_add_new_pet(auth_key, "Суперкот", "кот", 3, "images/coon1.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
